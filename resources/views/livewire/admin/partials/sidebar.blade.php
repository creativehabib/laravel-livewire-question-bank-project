    ...
    <nav class="flex-1 px-4 py-4 space-y-2 overflow-y-auto">
        ...
        @elseif(auth()->user()->isTeacher())
            ...
            <a wire:navigate href="{{ route('questions.set.create') }}"
               class="nav-link flex items-center gap-3 px-4 py-2.5 rounded-lg {{ request()->routeIs('questions.set.create') ? 'bg-indigo-50 dark:bg-gray-700 text-indigo-600 dark:text-indigo-400 font-semibold' : '' }}">
