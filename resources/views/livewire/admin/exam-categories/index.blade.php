            ...
            @forelse($examCategories as $examCat)
                <tr class="hover:bg-indigo-50/50 dark:hover:bg-gray-700/50 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right space-x-1">
                        ...
                        <button type="button" wire:click="edit({{ $examCat->id }})"
                ...
                <form wire:submit.prevent="save">
                    <div class="px-6 py-6 space-y-5">
                        <div>
                            ...
                            <input type="text" wire:model="name" placeholder="e.g. Admission Exam" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:bg-gray-700 dark:text-white dark:border-gray-600">
