            ...
            @forelse($subjects as $subject)
                <tr class="hover:bg-indigo-50/50 dark:hover:bg-gray-700/50 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right space-x-1">
                        ...
                        <button type="button" wire:click="edit({{ $subject->id }})"
                                class="inline-flex items-center justify-center w-8 h-8 rounded-md text-indigo-500 hover:text-white hover:bg-indigo-500 transition-colors border border-indigo-100 hover:border-transparent dark:border-gray-600 dark:hover:bg-indigo-600" title="Edit Subject">
                        ...
                        <button type="button"
                                ...
                                "
                                class="inline-flex items-center justify-center w-8 h-8 rounded-md text-red-500 hover:text-white hover:bg-red-500 transition-colors border border-red-100 hover:border-transparent dark:border-gray-600 dark:hover:bg-red-600" title="Delete Subject">
                ...
                <form wire:submit.prevent="save">
                    <div class="px-6 py-6 space-y-5">
                        <div>
                            ...
                            <input type="text" wire:model="name" placeholder="e.g. Mathematics" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 dark:bg-gray-700 dark:text-white dark:border-gray-600">
...
@push('scripts')
    <script>
        ...
        window.addEventListener('subjectDeleted', e => {
            showToast(e.detail.message || 'Subject has been deleted successfully.');
        });
    </script>
@endpush
