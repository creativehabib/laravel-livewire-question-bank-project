<div class="flex bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 antialiased">
            ...
            @forelse ($recentQuestions as $question)
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-700/50 transition-colors">
                    ...
                    <td class="p-4 space-x-2">
                        <a href="/admin/questions/{{ $question->id }}/edit" class="text-indigo-500 hover:text-indigo-700 font-medium">Edit</a>
